...
namespace sysAplicativo.Controllers
{
    public class PatrimoniosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,numetiqueta,nomepatrimonio,descricaopatrimonio,valorpatrimonio,idcategoria,idlocal,iddepartamento,marcaModelo,dataaquisicao,databaixa,numNf,numserie,idfornecedor,datagarantia")] DbPatrimonio dbPatrimonio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,numetiqueta,nomepatrimonio,descricaopatrimonio,valorpatrimonio,idcategoria,idlocal,iddepartamento,marcaModelo,dataaquisicao,databaixa,numNf,numserie,idfornecedor,datagarantia")] DbPatrimonio dbPatrimonio)
        {
